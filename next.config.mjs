                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: [
                            ...
                            "img-src 'self' data: https: blob: https://forms.hubspot.com",
                            "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://meet.jit.si wss://*.jitsi.net https://forms.hubspot.com https://api.hubspot.com",
                            "frame-src 'self' https://meet.jit.si https://8x8.vc https://forms.hubspot.com https://share.hsforms.com",
